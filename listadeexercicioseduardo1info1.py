...
def preco_com_desconto(preco_original, percentual_desconto):
    ...
    novo preço"""
     ...
     preco_original = preco_original + ((preco_original * percentual_desconto / 100 ))
     return novo_preco
...
def media_final_aprovado_reprovado(p1, p2, ep1, ep2):
   ...
   nota_inteira_1 = p1 + ep1
   nota_inteira_2 = p2 + ep2
   media = nota_inteira_1 + nota_inteira_2 / 2
