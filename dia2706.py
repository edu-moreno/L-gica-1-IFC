...
def preco_com_desconto(preco_original, percentual_desconto):
    ...
    desconto = round(preco_original - percentual_desconto, 2)
    return desconto
...
def dias_para_segundos(dias, horas, minutos, segundos):
    ...
    minutos= minutos * 60
    segundos= segundos * 1
    data_segundos= minutos + dias + horas + minutos + segundos

    return round (data_segundos, 2)
...
def celsius_para_fahrenheit(c):
    ...
    fahrenheit = round(float(9.0 / 5.0) * c + 32, 2)
    return fahrenheit
...
def fahrenheit_para_celsius(f):
    ...
    Celsius = round(float(f - 32) * 5.0 / 9.0, 2)
    return Celsius
...
def tinta(metros_pintar):
    ...
    lata_tinta = 18 * 3
    quantidade = metros_pintar / tinta
    return lata_tinta
